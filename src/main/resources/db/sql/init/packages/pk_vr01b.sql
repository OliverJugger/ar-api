CREATE OR REPLACE PACKAGE ARTHUS.pk_vr01b AS
--
PROCEDURE P_vr01b(
...
CREATE OR REPLACE PACKAGE BODY ARTHUS.pk_vr01b AS
-- Chaine de reconnaissance SCCS
-- %W%	%E%
...
EXCEPTION WHEN OTHERS THEN
		G_niv_msg	:= 0;
		G_msg_adm	:= 'PK_GD03B - '||SUBSTR(SQLERRM(SQLCODE),1,128);
