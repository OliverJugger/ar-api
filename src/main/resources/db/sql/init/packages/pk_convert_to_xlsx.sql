CREATE OR REPLACE package ARTHUS.pk_convert_to_xlsx
is

/*==============================================================================*/
  /* Package      : pk_convert_to_xlsx.sql                                     */
  /* Version      : V1.0                                                        */
  /* Auteur       : ARTHUS                                                      */
  /* Création     : 06/11/2019                                                  */
  /* Description  : permet de generer un fichier excel xlsx 
                        en partant d'une requete sql                            */
  /*              :                                                             */
  /*              :                                                             */
  /*============================================================================*/
  /*Commentaire  :                                                              */
...
--
  procedure convert_to_xlsx (  p_requete in varchar2,
                              p_directory in varchar2,
                              p_nom_fich in varchar2 ,
...
/* Example
begin
  as_xlsx.clear_workbook;              --as_xlsx est l'ancien nom de ce package
  as_xlsx.new_sheet;
  as_xlsx.cell( 5, 1, 5 );
  as_xlsx.cell( 3, 1, 3 );
  as_xlsx.cell( 2, 2, 45 );
...
CREATE OR REPLACE package body ARTHUS.pk_convert_to_xlsx
is
--
...
/***********************************************************************************/
/*==============================================================================*/
  /* Procedure      : convert_to_xlsx                                           */
  /* Version      : V1.0                                                        */
  /* Auteur       : ARTHUS                                                      */
  /* Création     : 06/11/2019                                                  */
  /* Description  : permet de generer un fichier xlsx qui est alimenté 
                         par le resultat d'une requete sql                      */
  /*              :                                                             */
  /*              :                                                             */
  /*============================================================================*/
  /*Commentaire  :                                                              */
 ...
 is
 begin
   pk_convert_to_xlsx.query2sheet( p_requete );
   pk_convert_to_xlsx.save( p_directory, p_nom_fich );
 exception
 when others then
  o_erreur :='echec de traitement pk_convert_to_xlsx.convert_to_xlsx';
       pk_trace.p_ins_journal_adm (  'CONVERT2XLSX',
                                  SID,
                                  3,
