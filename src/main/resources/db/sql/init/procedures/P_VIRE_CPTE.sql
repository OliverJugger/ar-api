CREATE PROCEDURE ARTHUS."P_VIRE_CPTE" (
...
-- v_numremise_deb   remise_vire.numremise%type;
-- v_numremise_fin   remise_vire.numremise%type;
-- v_nbre_vire    remise_vire.nombre%type;
...
--
   CURSOR c_decais (i_numcpte NUMBER, i_codope_deb NUMBER, i_codope_fin NUMBER)
   IS
