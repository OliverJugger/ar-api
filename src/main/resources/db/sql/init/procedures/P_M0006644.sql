CREATE PROCEDURE ARTHUS.P_M0006644 IS

-- attention : verifier heure de fin de traitement

  cursor c_cur is 
    select * from M0006644
	where traite = 'N'
	--and numindiv = 84275  -- pour test
	; 
  cur c_cur%rowtype ; 
...
begin
  ...
  for cur in c_cur loop
    ...
    IF loc_heure >=13 and loc_minutes >= 50 THEN
	  PK_trace.P_INS_journal_adm (
          I_nom_traitement => 'M0006644',
          I_session  => 0,
          I_niv_msg  => 1,
