CREATE FORCE VIEW ARTHUS.V_COMPTA342 AS
SELECT   DISTINCT
         ...
         ,0                                                                  int
         ,''                                                                 bqe         
         ,substr(TO_CHAR(F_CPTA_LIB_ENCAISMT(9281,encaismt.numencaismt,1)
               ,'00000000'),2,8)
...
--
  ...
  AND  compte_client.idcompta  = -1
GO
CREATE OR REPLACE PUBLIC SYNONYM V_COMPTA342 FOR ARTHUS.V_COMPTA342
