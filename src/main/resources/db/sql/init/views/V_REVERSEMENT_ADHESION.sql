CREATE FORCE VIEW ARTHUS.V_REVERSEMENT_ADHESION AS
select	grnts.refcie,
	...
	qttc_global.numquerable numcli,
	qttc_global.debut,
	qttc_global.fin,
	qttc_global.numeche,
...
Group by
	...
	adhe_cntrt.ref_ext
GO
CREATE OR REPLACE PUBLIC SYNONYM V_REVERSEMENT_ADHESION FOR ARTHUS.V_REVERSEMENT_ADHESION
