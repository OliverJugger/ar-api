 ...
 *   - en colonne brute {@code numgar} (Long), utilisée pour filtrer sans jointure,
 *   - en association {@code contratRef} en lecture seule pour la navigation objet.
 */
@Entity
...
public class AdheCntrt {
    ...
    @OneToMany(mappedBy = "adheCntrt", fetch = FetchType.LAZY)
    @Builder.Default
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
