...
@Component
public class RelRelatedIndividualTaskUuidRuleV2 implements RelRelatedIndividualRuleV2 {
	...
	public Predicate apply(Root<RelRelatedIndividualV2> root, CriteriaBuilder builder, RelRelatedIndividualSearchCriteria criteria) {
		return builder.equal(root.get(RelRelatedIndividualRuleFields.TASK_UUID_FIELD_NAME), criteria.getTaskUuid().toString());
	}
