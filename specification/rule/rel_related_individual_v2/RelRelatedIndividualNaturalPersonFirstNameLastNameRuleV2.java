...
@Component
public class RelRelatedIndividualNaturalPersonFirstNameLastNameRuleV2 implements RelRelatedIndividualRuleV2 {
	...
	public boolean matches(RelRelatedIndividualSearchCriteria criteria) {
		return Optional.ofNullable(criteria)
				.map(RelRelatedIndividualSearchCriteria::getNaturalPersonNameContains)
				.map(Objects::nonNull)
				.orElse(false);
	}
		...
		return builder.or(
				builder.like(
						uciEntityNaturalPerson
								.get(RelRelatedIndividualRuleFields.FIRSTNAME_FIELD_NAME),
						'%' + criteria.getNaturalPersonNameContains() + '%'),
				builder.like(
				...
				builder.like(
						uciEntityNaturalPerson
								.get(RelRelatedIndividualRuleFields.LASTNAME_FIELD_NAME),
						'%' + criteria.getNaturalPersonNameContains() + '%'),
				builder.like(
						legalPersonNaturalPerson
								.get(RelRelatedIndividualRuleFields.LASTNAME_FIELD_NAME),
