...
@Component
public class RelRelatedIndividualUciEntityIdAndTypeIntlIdRuleV2 implements RelRelatedIndividualRuleV2 {
	...
	public Predicate apply(Root<RelRelatedIndividualV2> root, CriteriaBuilder builder, RelRelatedIndividualSearchCriteria criteria) {
		...
		return builder.and(
				...
				builder.equal(
					uciEntityNaturalPerson
						.get(RelRelatedIndividualRuleFields.TYPE_FIELD_NAME)
