...
@Component
public class RelRelatedIndividualTypeCategoryIntlIdRuleV2 implements RelRelatedIndividualRuleV2 {
	...
	public Predicate apply(Root<RelRelatedIndividualV2> root, CriteriaBuilder builder, RelRelatedIndividualSearchCriteria criteria) {
		return builder.equal(
					root
						...
						.get(RelRelatedIndividualRuleFields.RELATED_INDIVIDUAL_CATEGORY_TYPE_FIELD_NAME)
