...
@Component
public class RelatedEntityTypeIsLegalPersonRule implements RelatedEntityTypeRule {
	private static final long serialVersionUID = 1L;

	@Override
    public boolean matches(RelatedEntityTypeSearchCriteria criteria) {
    	return Optional.ofNullable(criteria)
    			.map(RelatedEntityTypeSearchCriteria::getIsLegalPerson)
