...
@Component
public class RelatedIndividualTypeIsSubFundRule implements RelatedIndividualTypeRule {
	private static final long serialVersionUID = 1L;

	@Override
    public boolean matches(RelatedIndividualTypeSearchCriteria criteria) {
    	return Optional.ofNullable(criteria)
    			.map(RelatedIndividualTypeSearchCriteria::getIsSubFund)
